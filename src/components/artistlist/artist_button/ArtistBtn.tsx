...
export const ArtistBtn = ({
  ...
  return (
    <div 
      className={`grid grid-cols-[50px_minmax(0,1fr)_80px] justify-center items-center border border-eerie-black-20 gap-4 ${isLight ? "bg-[#FFFFFF]" : "bg-onyx"} rounded-[10px] w-full px-4 py-3`}
    >
      {artist.imageUrl ? (
