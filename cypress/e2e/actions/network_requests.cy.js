...
context("Network Requests", () => {
  ...
  it("/api/tracks endpoint", () => {
    // https://on.cypress.io/request
    cy.fixture("searches").then((searches) => {
      cy.request({
        ...
        body: {
          ...
          user: {
            ip: searches[0].ip,
            geolocation: {
              city: searches[0].city,
              country: searches[0].country,
              coordinates: searches[0].coordinates,
              timezone: searches[0].timezone,
            },
          },
        },
      }).should((response) => {
